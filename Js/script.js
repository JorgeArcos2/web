...
function showDedicationText() { 
  ...
  if (!text) {
    text = `Para mi persona favorita:\n\nSolo quería decirte que eres una mujer increíble, trabajadora y muy valiosa.
\n\n Admiro ver cómo le echas ganas a la vida a pesar de lo difícil que se pone a veces.\n\n No olvides que aquí estoy para apoyarte.
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con cariño, Jorge Arcos";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-07-15T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-07-28T17:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `días transcurridos a la entrega: <b>${days}</b> días<br>` +
      `días/horas faltantes: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
